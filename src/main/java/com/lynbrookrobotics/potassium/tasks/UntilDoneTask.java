...
/**
 * A finite task that runs a finite task, but also a continuous task until the finite task is finished
 */
public class UntilDoneTask extends FiniteTask {
     ...
     *
     * This constructor should NOT be used, the task1.andUntilDone(task2) method should be used instead
