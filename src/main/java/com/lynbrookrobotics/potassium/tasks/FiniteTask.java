...
public abstract class FiniteTask extends Task {
    ...
    /**
     * Creates a task where a continuous task is run in parallel with this task until this task completes
    ...
    /**
     * What to do at the end of the task (either gracefully from finished() or from abort())
